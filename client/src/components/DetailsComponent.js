...
const DetailsComponent = ({ selectedData, onStatusChange, onPersonnelChange, onPriorityChange }) => {
  ...
  const updateStatusInDB = async (newStatus) => {
    try {
      const response = await axios.put("https://4454-136-233-9-98.ngrok-free.app/update-status", {
  ...
  const updatePriorityInDB = async (newPriority) => {
    try {
      const response = await axios.put("https://4454-136-233-9-98.ngrok-free.app/update-priority", {
        _id: selectedData._id,
  ...
  const updateTeamInDB = async (newTeam) => {
    try {
      const response = await axios.put("https://4454-136-233-9-98.ngrok-free.app/update-team", {
        _id: selectedData._id,
